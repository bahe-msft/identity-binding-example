...
# Workload Identity Proxy Mode Deployment Configuration Script
# This script helps configure the workload identity proxy deployment with the correct values
# The proxy mode demonstrates the migration sidecar for applications using IMDS

set -e

echo "Workload Identity Proxy Mode Deployment Configuration"
echo "==================================================="
...
echo "Deploying Workload Identity Proxy Mode demo application..."
export KUBECONFIG="$KUBECONFIG_FILE"

kubectl apply -f deployment-configured.yaml

echo ""
echo "✅ Workload Identity Proxy Mode demo deployed successfully!"
echo ""
echo "📋 Important Notes:"
echo "- This deployment uses the migration sidecar for applications that rely on IMDS"
echo "- The sidecar provides backward compatibility while migrating to workload identity"
...
echo "1. Check status: KUBECONFIG=$KUBECONFIG_FILE kubectl get pods -l app=demo-app-wi-proxy -n demo-app-wi"
echo "2. View logs: KUBECONFIG=$KUBECONFIG_FILE kubectl logs -f -l app=demo-app-wi-proxy -n demo-app-wi"
echo "3. Check sidecar injection: KUBECONFIG=$KUBECONFIG_FILE kubectl describe pod -l app=demo-app-wi-proxy -n demo-app-wi"
echo ""
